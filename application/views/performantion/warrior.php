    ...
    <div class=" row">
        ...
        <div class="col-lg-6 ">
            <div class="d-inline text-right font-weight-bold">
                <p> <a class="btn btn-sm text-danger" href="<?= base_url('performantion'); ?>"><i class="fas fa-door-open text-danger"></i> Exit</a> Performantion Verifikasi Warrior IndiHome <i class="text-xs text-warning"><?= date('d-m-Y H:i:s'); ?></i></p>
            </div>
        </div>
    </div>
    <div class="card bg-gradient-dark shadow mb-4 text-white" style="opacity: 0.8;">
        ...
        <div class="card-body">
            <div class="table-responsive small">
                <form method="post" action=<?php echo site_url('performantion/warrior'); ?>>
                    <div class="row">
                        <div class="col-lg-3"></div>
                        <div class=" col-md-3">
                            <div class="form-group text-dark text-center">
                                <input value="<?= set_value('email'); ?>" name="email" id="email" onkeyup="this.value = this.value.toUpperCase()" class="form-control text-sm text-center" placeholder="Input Email">
                            </div>
                        </div>
