    ...
    <div class="row">
        ...
        <div class="col-lg-6 ">
            <div class="d-inline text-right font-weight-bold">
                <p> <a class="btn btn-sm text-danger" href="<?= base_url('user'); ?>"><i class="fas fa-door-open text-danger"></i> Exit</a> Verifikasi Existing SF <i class="text-xs text-warning"><?= date('d-m-Y H:i:s'); ?></i></p>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6 mb-3">
                <div class="card shadow bg-transparent">
                    <div class="card-body" style="opacity: 0.8;">
                        ...
                        <!--form-->
                        <form class="user" method="post" action="<?= base_url('verifikasi/existing'); ?>">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" onkeyup="this.value = this.value.toUpperCase()" name=" agency" id="agency" value="<?= set_value('agency'); ?>" class="form-control form-control-user text-center" placeholder="Agency" required>
                                        <?= form_error('agency', '<small class="text-danger pl-3">', '</small>'); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 text-center text-light">
                                        <label>No KTP SF</label>
                                        <input maxlength="16" type="text" onkeyup="this.value = this.value.toUpperCase()" name=" no_ktp" id="no_ktp" value="<?= set_value('no_ktp'); ?>" class="form-control form-control-user text-center" required>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-4 text-center text-light">
                                    <label>Email</label>
                                    <input type="email" name="email" id="email" value="<?= set_value('email'); ?>" class="form-control text-center" required>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                ...
                                                <div class="d-inline" onclick="javascript: return confirm('Are you sure want to delete this data ?')">
                                                    <a href="<?= site_url('verifikasi/deleteexisting/' . $m['id']) ?>" class="btn btn-outline-danger btn-sm"><i class="fas fa-edit"></i> Delete</a>
                                                </div>
