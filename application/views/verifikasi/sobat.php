    ...
    <div class="row">
        ...
        <div class="col-lg-6 ">
            <div class="d-inline text-right font-weight-bold">
                <p> <a class="btn btn-sm text-danger" href="<?= base_url('user'); ?>"><i class="fas fa-door-open text-danger"></i> Exit</a> Verifikasi Sobat IndiHome<i class="text-xs text-warning"><?= date('d-m-Y H:i:s'); ?></i></p>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6 mb-3">
                <div class="card shadow bg-transparent">
                    <div class="card-body" style="opacity: 0.8;">
                        ...
                        <!--form-->
                        <form class="user" method="post" action="<?= base_url('verifikasi/sobat'); ?>">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <input type="text" onkeyup="this.value = this.value.toUpperCase()" name=" id_sobat" id="id_sobat" value="<?= set_value('id_sobat'); ?>" class="form-control form-control-user text-center" placeholder="ID Sobat" required>
                                        <?= form_error('id_sobat', '<small class="text-danger pl-3">', '</small>'); ?>
                                    </div>
                                    <div class="col-lg-6">
                                        <input type="text" onkeyup="this.value = this.value.toUpperCase()" name=" nama_sobat" id="nama_sobat" value="<?= set_value('nama_sobat'); ?>" class="form-control form-control-user text-center" placeholder="Nama Sales" required>
                                        <?= form_error('nama_sobat', '<small class="text-danger pl-3">', '</small>'); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                ...
                                                <div class="d-inline" onclick="javascript: return confirm('Are you sure want to delete this data ?')">
                                                    <a href="<?= site_url('verifikasi/deletesobat/' . $m['id']) ?>" class="btn btn-outline-danger btn-sm"><i class="fas fa-edit"></i> Delete</a>
                                                </div>
