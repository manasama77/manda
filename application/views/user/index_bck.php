<div class="container-fluid my-auto">
	...
	<div class="row">
		<div class="col-12">
			<h5 class="h5 text-white">IDENTITAS</h5>
			<hr />
		</div>
	...
	<div class="row">
		<div class="col-lg-6">
			<h1 class="h5 mb-4 text-white">TOTAL DATA QC1 <i class="text-warning text-xs"><?= date('d-m-Y H:i:s'); ?></i></h1>
								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											...
											<div class="h5 mb-0 font-weight-bold text-white"><?= round((($satu + $dua + $tiga + $empat + $lima + $enam + $tujuh + $delapan + $sembilan + $sepuluh + $sebelas + $duabelas + $tigabelas + $empatbelas + $limabelas + $enambelas + $tujuhbelas + $sembilanbelas + $duapuluh + $duapuluhsatu + $duapuluhdua + $duapuluhtiga + $duapuluhempat + $duapuluhlima + $duapuluhenam + $duapuluhtujuh + $duapuluhdelapan + $duapuluhsembilan + $tigapuluh + $tigapuluhsatu) / $totaluniq), 2); ?></div>
										</div>
										<div class="col-auto">
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div class="text-xs text-left font-weight-bold text-white text-uppercase mb-1">
												This Month</div>
											<div class="h5 mb-0 text-left font-weight-bold text-white"><?= $mmenu; ?></div>
										</div>
										<div class="col-auto">
