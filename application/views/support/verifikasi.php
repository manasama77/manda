                    ...
                    <div class="table-responsive small">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-3">
                                <button id="btnFilter1" class="btn btn-primary form-control">Search</button>
                            </div>

                            <div class="col-md-2 mb-3">
                                <button class="btn btn-danger form-control" id="btnExportExcell1"><i class="fas fa-file-download"></i> Download</button>
                            </div>
                        </div>
