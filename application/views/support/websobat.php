    ...
    <div class=" row">
        ...
        <div class="col-lg-6 ">
            <div class="d-inline text-right font-weight-bold">
                <p> <a class="btn btn-sm text-danger" href="<?= base_url('support'); ?>"><i class="fas fa-door-open text-danger"></i> Exit</a> Report Web Sobat IndiHome<i class="text-xs text-warning"><?= date('d-m-Y H:i:s'); ?></i></p>
            </div>
        </div>
    </div>

    <!-- Page Heading -->
    <h1 class="h5 mb-4 text-white">REKAPITULASI WEB SOBAT INDIHOME</h1>
                    ...
                    <div class="table-responsive small">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-3">
                                <button id="btnFilter10" class="btn btn-primary form-control">Search</button>
                            </div>

                            <div class="col-md-2 mb-3">
                                <button class="btn btn-danger form-control" id="btnExportExcell10"><i class="fas fa-file-download"></i> Download</button>
                            </div>  
                        </div>
